...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden" style={{ backgroundColor: "#0A400C" }}>
      {/* Background Pattern */}
      ...
      >
        ...
        <div className="relative bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8 md:p-10">
          ...
          <div className="text-center mb-8">
            ...
            <motion.h1 variants={itemVariants} className="text-3xl font-bold text-white mb-2">Bienvenue</motion.h1>
            <motion.p variants={itemVariants} className="text-green-200">Connectez-vous à votre compte Raja</motion.p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <motion.div variants={itemVariants} className="space-y-2">
              <label className="text-sm font-medium text-green-100 block">Email</label>
            ...
            <motion.div variants={itemVariants} className="flex items-center justify-between text-sm">
              <label className="flex items-center space-x-2 cursor-pointer group">
                ...
                />
                <span className="text-green-200 group-hover:text-white transition-colors">Se souvenir de moi</span>
              </label>
              <Link href="/forgot-password" className="text-green-300 hover:text-white transition-colors font-medium">
                Mot de passe oublié?
              </Link>
            </motion.div>
            ...
            <motion.button
              ...
              className="w-full bg-transparent px-5 py-3 text-[#D4AF37] font-bold border-2 border-[#D4AF37] rounded-xl hover:bg-[#D4AF37] hover:text-[#0A400C] transition-all duration-300 shadow-lg hover:shadow-[#D4AF37]/20 flex items-center justify-center space-x-2 group"
            >
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-2 gap-4">
            <motion.button whileHover={{ y: -2 }} className="flex items-center justify-center space-x-2 py-3 px-4 bg-white/10 hover:bg-white/20 border border-white/20 rounded-xl transition-all">
          ...
          {/* Sign Up Link */}
          <motion.p variants={itemVariants} className="text-center mt-8 text-green-200">
            Pas encore de compte?{' '}
            <Link href="/signup" className="text-white font-bold hover:text-green-300 transition-colors">
              Créer un compte
            </Link>
          </motion.p>
        </div>
