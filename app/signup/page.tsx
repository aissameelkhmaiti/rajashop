...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen   flex items-center justify-center p-4 py-12"  style={{ backgroundColor: "#0A400C" }}>
      {/* Background Pattern */}
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="relative bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8 md:p-10">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-green-200">Créez votre compte Raja Club Athletic</p>
          </div>
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <User className="text-green-300" size={20} />
                </div>
                <input
                  type="text"
            ...
            <div className="flex items-start space-x-2">
              <input
                ...
                className="w-4 h-4 mt-1 rounded border-white/20 bg-white/10 text-green-500 focus:ring-2 focus:ring-green-500 focus:ring-offset-0"
              />
              <label className="text-sm text-green-200 cursor-pointer">
                J'accepte les{' '}
                <Link href="/terms" className="text-white font-medium hover:text-green-300 transition-colors">
                  conditions d'utilisation
                </Link>
                {' '}et la{' '}
                <Link href="/privacy" className="text-white font-medium hover:text-green-300 transition-colors">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-transparent text-green-200">ou s'inscrire avec</span>
            </div>
          </div>
