...
const Header = () => {
  ...
  const cartCount = 0; // Changé à 0 pour afficher le modal "panier vide"
  ...
  const handleCartClick = (e: React.MouseEvent) => {
    ...
    if (cartCount === 0) {
      ...
      // Rediriger vers la page panier si des articles existent
        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <button 
              ...
              className="relative p-2 text-[#D4AF37] hover:text-white transition-colors"
            >
